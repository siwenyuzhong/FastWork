    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', models.DateTimeField(verbose_name='登录时间')),
                ('is_superuser', models.CharField(max_length=10, verbose_name='是否管理员')),
                ('email', models.CharField(max_length=20, verbose_name='邮箱')),
                ('isSuccess', models.CharField(max_length=5, verbose_name='是否成功')),
            ],
        ),
        migrations.CreateModel(
            name='Structure',
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.Structure', verbose_name='父类架构')),
            ],
            options={
                'verbose_name': '组织架构',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.Structure', verbose_name='部门')),
