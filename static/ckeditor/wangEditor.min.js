!function (t, e) {
    ...
    function d(t, e) {
        ...
        var A = e.list || [], s = e.type || "list", l = e.onClick || O,
        ...
        constructor: i, forEach: function (t) {
            ...
            return i = t.split(/\s+/), this.forEach(function (t) {
                i.forEach(function (i) {
                    if (i) {
                        if (L.push({elem: t, type: i, fn: n}), !e) return void t.addEventListener(i, n);
    ...
    l.prototype = {
        constructor: l, onClick: function (t) {
    ...
    d.prototype = {
        ...
        constructor: u, _command: function (t) {
    ...
    p.prototype = {
                ...
                p.forEach(function (t, e) {
                    ...
                    if (e) {
                        (e.events || []).forEach(function (e) {
                            var i = e.selector, o = e.type, r = e.fn || G;
        ...
        constructor: h, onClick: function (t) {
            ...
            var n = this, i = c("input-link"), r = c("input-text"), a = c("btn-ok"), A = c("btn-del"),
                s = this._active ? "inline-block" : "none", l = new p(this, {
                    width: 300,
                    tabs: [{
                        title: "链接",
        ...
        constructor: v, onClick: function (t) {
        ...
        constructor: x, _command: function (t) {
        ...
        constructor: C, onClick: function (t) {
            ...
            var e = this;
            t = t || "";
            var n = t ? "edit" : "new", i = c("texxt"), r = c("btn"), a = new p(this, {
                width: 500,
                tabs: [{
                    title: "插入代码",
        ...
        constructor: Q, onClick: function () {
            ...
            var t = this, e = c("btn"), n = c("row"), i = c("col"), r = new p(this, {
                width: 250,
                tabs: [{
                    title: "插入表格",
        ...
        constructor: _, onClick: function () {
            ...
            var t = this, e = c("text-val"), n = c("btn"), i = new p(this, {
                width: 350,
                tabs: [{
                    title: "插入视频",
    ...
    q.bold = l, q.head = u, q.link = h, q.italic = f, q.redo = g, q.strikeThrough = m, q.underline = w, q.undo = v, q.list = b, q.justify = x, q.foreColor = y, q.backColor = E, q.quote = B, q.code = C, q.emoticon = I, q.table = Q, q.video = _, q.image = D, k.prototype = {
        ...
        constructor: R, init: function () {
            ...
            var e = this.editor, n = e.$textElem, i = void 0;
            ...
            var n = this.editor, i = n.config, o = i.pasteFilterStyle, r = i.pasteTextHandle, a = n.$textElem, c = 0;
        ...
        constructor: T, getRange: function () {
    ...
    H.prototype = {
        constructor: H, _alert: function (t, e) {
    ...
    var K = 1;
    Y.prototype = {
        constructor: Y, _initConfig: function () {
            var t = {};
